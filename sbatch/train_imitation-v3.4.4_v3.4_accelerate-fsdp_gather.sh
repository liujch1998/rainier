#!/bin/bash
#SBATCH --job-name=train_imitation-v3_uqa_no-lowercase_answer128_align-qk-qa_qka-loss_accelerate-fsdp_gather
...
accelerate launch --config_file ../accelerate_fsdp.cfg imitation_v3.py \
    --model_type allenai/unifiedqa-t5-large --batch_size 4 --qka_loss \
    --job_name train_imitation-v3_uqa_no-lowercase_answer128_align-qk-qa_qka-loss_accelerate-fsdp_gather
