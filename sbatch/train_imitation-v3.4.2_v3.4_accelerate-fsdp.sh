#!/bin/bash
#SBATCH --job-name=train_imitation-v3_uqa_no-lowercase_answer128_align-qk-qa_qka-loss_accelerate-fsdp
...
accelerate launch --config_file ../accelerate_fsdp.cfg imitation_v3.py \
    ...
    --job_name train_imitation-v3_uqa_no-lowercase_answer128_align-qk-qa_qka-loss_accelerate-fsdp
